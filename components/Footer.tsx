    ...
    <footer className="bg-slate-950 py-10 border-t border-slate-800">
      <div className="container mx-auto px-6 text-center">
        ...
        <nav className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6 mb-8 text-sm text-slate-300 uppercase tracking-wider" aria-label="Fußzeilen-Navigation">
          ...
          <a href="#agb" className="hover:text-gold-500 focus:text-gold-500 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2 focus:ring-offset-slate-950 rounded transition-colors">AGB</a>
          <a href="#impressum" className="hover:text-gold-500 focus:text-gold-500 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2 focus:ring-offset-slate-950 rounded transition-colors">Impressum</a>
          <a href="#datenschutz" className="hover:text-gold-500 focus:text-gold-500 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-offset-2 focus:ring-offset-slate-950 rounded transition-colors">Datenschutz</a>
        </nav>
